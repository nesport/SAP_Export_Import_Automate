...
# заменить солман sed -i "s/sl1cidb/$(hostname -s)/g" /usr/sap/DA1/SMDA97/SMDAgent/applications.config/com.sap.smd.agent.application.wilyhost/IntroscopeSapAgent.profile
